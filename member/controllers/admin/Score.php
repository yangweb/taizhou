...
class Score extends M_Controller {
    ...
    public function index() {
		...
		$this->template->assign(array(
			...
			'name' => SITE_SCORE,
			'param'	=> $_param,
			'pages'	=> $this->get_pagination(man_url('member/score/index', $param), $param['total'])
		));
    ...
    public function add() {
		...
		if (IS_POST) {
			...
			$this->member_model->add_notice($this->userinfo['uid'], 1, man_lang('m-080', SITE_SCORE, $value, $this->member['username']));
